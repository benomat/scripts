if game.PlaceId == 3623096087 then
    ...
    button1.Text = "Weight âŽ"
    button1.TextColor3 = Color3.fromRGB(0, 0, 0)
    button1.TextSize = 13.000
    button1.MouseButton1Click:Connect(function()
      if button1.Text == "Weight âŽ"then
    button1.Text = "Weight âœ…"
    ...
    elseif button1.Text == "Weight âœ…" then
    button1.Text = "Weight âŽ"
    if plr.Character:FindFirstChild("Weight") or plr.Backpack:FindFirstChild("Weight") ~= nil then
    ...
    button2.Text = "Pushups âŽ"
    button2.TextColor3 = Color3.fromRGB(0, 0, 0)
    button2.TextSize = 13.000
    button2.MouseButton1Click:Connect(function()
      if button2.Text == "Pushups âŽ"then
    button2.Text = "Pushups âœ…"
    ...
    elseif button2.Text == "Pushups âœ…" then
    button2.Text = "Pushups âŽ"
    if plr.Character:FindFirstChild("Pushups") or plr.Backpack:FindFirstChild("Pushups") ~= nil then
    ...
    button3.Text = "Situps âŽ"
    button3.TextColor3 = Color3.fromRGB(0, 0, 0)
    button3.TextSize = 13.000
    button3.Visible = true
    button3.MouseButton1Click:Connect(function()
      if button3.Text == "Situps âŽ"then
    button3.Text = "Situps âœ…"
    ...
    elseif button3.Text == "Situps âœ…" then
    button3.Text = "Situps âŽ"
    if plr.Character:FindFirstChild("Situps") or plr.Backpack:FindFirstChild("Situps") ~= nil then
    ...
    button4.Text = "Handstands âŽ"
    button4.TextColor3 = Color3.fromRGB(0, 0, 0)
    button4.TextSize = 13.000
    button4.MouseButton1Click:Connect(function()
      if button4.Text == "Handstands âŽ"then
    button4.Text = "Handstands âœ…"
    ...
    elseif button4.Text == "Handstands âœ…" then
    button4.Text = "Handstands âŽ"
    if plr.Character:FindFirstChild("Handstands") or plr.Backpack:FindFirstChild("Handstands") ~= nil then
    ...
    button6.Text = "Rock 0 âŽ"
    button6.TextColor3 = Color3.fromRGB(0, 0, 0)
    button6.TextSize = 13.000
    button6.MouseButton1Click:Connect(function()
      if button6.Text == "Rock 0 âŽ" then
    button6.Text = "Rock 0 âœ…"
    getgenv().Dura0 = true
    ...
    elseif button6.Text == "Rock 0 âœ…" then
    button6.Text = "Rock 0 âŽ"
    getgenv().Dura0 = false
    while getgenv().Dura0 do
    wait()
    ...
    button7.Text = "Rock 10 âŽ"
    button7.TextColor3 = Color3.fromRGB(0, 0, 0)
    button7.TextSize = 13.000
    button7.MouseButton1Click:Connect(function()
      if button7.Text == "Rock 10 âŽ" then
    button7.Text = "Rock 10 âœ…"
    getgenv().Dura10 = true
    ...
    elseif button7.Text == "Rock 10 âœ…" then
    button7.Text = "Rock 10 âŽ"
    ...
    button8.Text = "Rock 100 âŽ"
    button8.TextColor3 = Color3.fromRGB(0, 0, 0)
    button8.TextSize = 13.000
    button8.MouseButton1Click:Connect(function()
      if button8.Text == "Rock 100 âŽ" then
    button8.Text = "Rock 100 âœ…"
    ...
    elseif button8.Text == "Rock 100 âœ…" then
    button8.Text = "Rock 100 âŽ"
    ...
    elseif button9.Text == "Rock 5k âœ…" then
    button9.Text = "Rock 5k âŽ"
    ...
    elseif button10.Text == "Rock 150k âœ…" then
    button10.Text = "Rock 150k âŽ"
    ...
    elseif button11.Text == "Rock 400k âœ…" then
    button11.Text = "Rock 400k âŽ"
    ...
    elseif button12.Text == "Rock 750k âœ…" then
    button12.Text = "Rock 750k âŽ"
    ...
    elseif button13.Text == "Rock 1m âœ…" then
    button13.Text = "Rock 1m âŽ"
    ...
    elseif button14.Text == "Rock 5m âœ…" then
    button14.Text = "Rock 5m âŽ"
    ...
    elseif button15.Text == "Legend Throw âœ…" then
    button15.Text = "Legend Throw âŽ"
    getgenv().Throw = false
    while getgenv().Throw do
    wait()
    ...
    elseif button16.Text == "Legend Squat âœ…" then
    button16.Text = "Legend Squat âŽ"
    getgenv().Squat = false
    while getgenv().Squat do
    wait()
    ...
    elseif button17.Text == "Legend Press âœ…" then
    button17.Text = "Legend Press âŽ"
    getgenv().press = false
    while getgenv().press do
    wait()
    ...
    elseif button18.Text == "Legend Pullup âœ…" then
    button18.Text = "Legend Pullup âŽ"
    ...
    elseif button19.Text == "Treadmill âœ…" then
    button19.Text = "Treadmill âŽ"
    ...
    elseif button20.Text == "Rebirth âœ…" then
    button20.Text = "Rebirth âŽ"
    ...
    elseif button21.Text == "Punch speed âœ…" then
    button21.Text = "Punch speed âŽ"
    getgenv().speed = false
    end
    end)
    ...
    elseif button23.Text == "Treadmill v2 âœ…" then
    button23.Text = "Treadmill v2 âŽ"
    ...
    elseif button24.Text == "Weight v2 âœ…" then
    button24.Text = "Weight v2 âŽ"
    ...
    elseif button25.Text == "Kill all âœ…" then
    button25.Text = "Kill all âŽ"
    getgenv().kill = false
    while getgenv().kill do
    wait()
    ...
    elseif button26.Text == "Join Brawl âœ…" then
    button26.Text = "Join Brawl âŽ"
    getgenv().brawl = false
    end
    end)
    ...
    elseif button28.Text == "Kill Npc âœ…" then
    button28.Text = "Kill Npc âŽ"
    getgenv().mob = false
    while getgenv().mob do
        wait()
